...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 502.0, 742.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 516.0, 668.0, 125.0, 22.0 ],
					"text" : "0.1 15000 0.99 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 552.0, 697.0, 40.0, 22.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 353.0, 447.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 353.0, 481.0, 56.0, 22.0 ],
					"text" : "metro 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 348.0, 524.0, 91.0, 22.0 ],
					"text" : "drunk 3000 110"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1150.0, 182.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1150.0, 216.0, 56.0, 22.0 ],
					"text" : "metro 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1145.0, 259.0, 105.0, 22.0 ],
					"text" : "drunk 50000 3000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.0, 702.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 628.0, 125.0, 22.0 ],
					"text" : "0.1 15000 0.99 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 443.0, 657.0, 40.0, 22.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.0, 579.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 441.0, 188.0, 22.0 ],
					"text" : "20. 10000 2000. 15000 110. 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 240.0, 516.0, 40.0, 22.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 450.0, 87.0, 56.0, 22.0 ],
					"text" : "metro 50"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.026666666666667, 0, 2.659574468085106, 1.0, 0, 51.595744680851062, 0.36, 0, 74.468085106382972, 0.32, 0, 100.0, 0.0, 0 ],
					"domain" : 100.0,
					"id" : "obj-16",
					"maxclass" : "function",
					"numinlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 402.5, 729.0, 378.0, 729.0, 378.0, 624.0, 416.5, 624.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 511.5, 769.0, 487.0, 769.0, 487.0, 664.0, 525.5, 664.0 ],
					"source" : [ "obj-45", 0 ]
				}
