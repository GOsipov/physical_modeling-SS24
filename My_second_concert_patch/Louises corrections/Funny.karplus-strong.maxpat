...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 441.0, 242.0, 181.0 ],
					"presentation_linecount" : 13,
					"text" : "For your piece, you should decide which one to use: Karplus-Strong or the one with an Allpass Filter. Right now, this is still set up like the pedagogical patch we made in class. If you are going to use both strings, decide what you will do with it: will you fade in and out between the string models? Will you send the output of one string to a single channel and the other to the opposite? Decide on a way to use them both if you intend to use them both, but currently, they are just interfering with each other in each of the two channels. ",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.0, 22.0, 213.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 863.0, 34.0, 239.0, 87.0 ],
					"text" : "Good settings saved in your preset object, but how will you excite your model? When I click on a preset, it typically STOPS the metro object. Are you going to use a MIDI controller or something else to \"play\" the string?",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1154.0, 196.0, 157.0, 87.0 ],
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.026666666666667, 0, 2.659574468085106, 1.0, 0, 3.191489361702128, 0.653333333333333, 0, 64.893617021276597, 0.0, 0, 100.0, 0.0, 0 ],
					"domain" : 100.0,
					"id" : "obj-16",
					"maxclass" : "function",
					"numinlets" : 1,
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/myClasses/physical-modeling-SS2024/week-05-karplus-strong",
				"patcherrelativepath" : "../../../../../../physical-modeling-SS2024/week-05-karplus-strong",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
